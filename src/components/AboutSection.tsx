...
const AboutSection = () => (
  <section id="about-me" className="bg-card rounded-xl border border-border p-6 md:p-8">
    ...
    <p className="text-muted-foreground leading-relaxed mb-2">
      Hi, I'm <span className="font-semibold text-foreground">Zetee Professional</span>, based in California, United States. I'm a passionate eCommerce brands transformer and results-driven digital marketing strategist as well as certified full-stack website developer.
    </p>
